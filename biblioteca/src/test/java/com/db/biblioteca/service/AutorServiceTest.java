...
public class AutorServiceTest {
    ...
    void deveLancarExcecaoQuandoCpfRepetidoQuandoAtualizarAutor() {
        autorService.criarAutor(
                new AutorRequest("Maria", "NB", 2005, "11188833399"));

        autorService.criarAutor(
                new AutorRequest("Joana", "M", 2005, "12345678901"));
    ...
    void deveAtualizarAutorQuandoTodosDadosValidos() {
        ...
        autorService.criarAutor(
                new AutorRequest("Joana", "M", 2002, "11122233344"));

        autorService.atualizarAutor(1L,
                new AutorRequest("Maria", "NB", 2005, "10987654321"));
    ...
    void deveConterAutorQuandoVincularAutorAoLivro() {
        AutorRequest autorRequest =
                new AutorRequest("Maria", "F", 2005, "12345678901");
    ...
    @Test
    void deveRemoverAutorQuandoAutorExistente() {
        Autor autor = autorService.criarAutor(
                new AutorRequest("Maria", "NB", 2005, "12345678901"));
    ...
    void deveLancarExcecaoQuandoNomeNulo() {
        assertThrows(RuntimeException.class,
                () -> autorService.criarAutor(
                        new AutorRequest(null, "NB", 2005, "12345678901")));
    }
    ...
    void deveLancarExcecaoQuandoNomeBlank() {
        assertThrows(RuntimeException.class,
                () -> autorService.criarAutor(
                        new AutorRequest("", "NB", 2005, "12345678901")));
    }
    ...
    void deveLancarExcecaoQuandoCpfNulo() {
        assertThrows(RuntimeException.class,
                () -> autorService.criarAutor(
                        new AutorRequest("Maria", "NB", 2005, null)));
    }
    ...
    void deveLancarExcecaoQuandoCpfBlank() {
        assertThrows(RuntimeException.class,
                () -> autorService.criarAutor(
                        new AutorRequest("Maria", "NB", 2005, " ")));
    }
    ...
    void deveLancarExcecaoQuandoCpfTamanhoInvalido() {
        assertThrows(RuntimeException.class,
                () -> autorService.criarAutor(
                        new AutorRequest("Maria", "NB", 2005, "12345")));
    }
}
